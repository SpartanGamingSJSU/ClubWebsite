...
<template>
  <div id="schedule">
    <div class="flex flex-col justify-center items-center">
      <img :src="'/BannerPictures/PagesBanner.png'" class="object-fill w-full max-h-[865px] opacity-90"/>
    ...
    <div class="flex items-center justify-center lg:py-40 py-10 px-20">
      <div class="flex flex-col justify-center items-center bg-orange-300 p-12 shadow-lg rounded-lg gap-4">
        <div class="border-4 border-orange-500 rounded-lg px-16 py-10">
          ...
          <h3 class="text-2xl font-bold text-orange-600 mt-6">GUILDHOUSE MEETUPS</h3>
          <p class="text-lg text-black font-semibold">Tuesdays @6pm</p>
        </div>
